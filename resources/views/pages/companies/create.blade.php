...
scola-apply.companies.index') }}">
    <i class="bx bx-chevron-left"></i> Back to Company Dashboard
</a>
@stop
...
scola-apply.companies.store','class'=>'form-horizontal']) !!}
            
                @include('scola-apply
nda-hrm-module::pages.companies.fields')

                <div class="col-lg-offset-3 col-lg-9">
                    <hr />
                    {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
                    <a href="{{ route('scola-apply
scola-apply.companies.index') }}" class="btn btn-default btn-warning">Cancel</a>
                </div>
