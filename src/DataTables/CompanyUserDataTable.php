...
namespace Maitiigor\RC\DataTables;
...
class CompanyUserDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'nda-hrm-module::pages.company_users.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\CompanyUser $model
    ...
    {
        return 'company_users_datatable_' . time();
    }
}
