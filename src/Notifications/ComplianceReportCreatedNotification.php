...
class ComplianceReportCreatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('ComplianceReport created successfully')
                                ->markdown(
                                    'mail.complianceReports.created',
