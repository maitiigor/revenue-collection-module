...
class ComplianceReportUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('ComplianceReport updated successfully')
                                ->markdown(
                                    'mail.complianceReports.updated',
